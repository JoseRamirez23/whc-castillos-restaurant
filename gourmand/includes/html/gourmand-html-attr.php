<?php
	...
	if( !class_exists( 'gourmand_html_attr' ) ){
		class gourmand_html_attr
		{
    		function get( $attr, $args, $just_value = false )
    		{
    			...
    			switch( $attr ){
		            ...
		            case 'class' :{
		            	$args = apply_filters( 'gourmand_html_attr__class', $args, $slug );
		...
		add_filter( 'gourmand_html_attr__slug',		array( 'gourmand_html_attr', '_slug' ), 10, 2 );
		add_filter( 'gourmand_html_attr__class',	array( 'gourmand_html_attr', '_class' ), 10, 2 );
	}
?>
